...
class DrivingLicenseContract extends SmartContract {
  ...
  @method async apply_for_driving_license(proof_address: PublicKey) {
    //const proof_of_age = new ProofOfAge(proof_address)
    await ProofOfAge.verifyAdulthood(this.sender.getAndRequireSignature(),proof_address,Field(3392518251768960475377392625298437850623664973002200885669375116181514017494n));
  }
}
